class Project < ApplicationRecord
  ...
  before_validation { self.asset.clear if self.delete_picture == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_1 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_2 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_3 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_4 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_5 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_6 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_7 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_8 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_9 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_10 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_11 == '1' }
  ...
  before_validation { self.asset.clear if self.delete_project_picture_12 == '1' }
